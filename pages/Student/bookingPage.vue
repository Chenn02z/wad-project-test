<template>
    <div class="container mx-auto p-4">
        <div class="space-y-0.5 mb-6">
            ...
            <p class="text-muted-foreground">Select the instructor, location, date, and timeslot</p>
        </div>
        ...
        <div class="p-6 max-w-md mx-auto bg-white rounded-lg shadow-md">
            ...
            <form v-else @submit.prevent="confirmBooking" class="space-y-4">
                <div class="space-y-2">
                    ...
                    <select v-model="selectedLocation" id="location" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
                ...
                <div v-if="selectedInstructor" class="space-y-2">
                    ...
                    <select v-model="selectedDate" id="date" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md" @change="fetchAvailableSlots">
                ...
                <div v-if="selectedDate" class="space-y-2">
                    ...
                    <div class="grid grid-cols-3 gap-2">
                        <button v-for="slot in availableSlots" :key="slot.time" type="button"
                            ...
                            :class="['p-2 text-sm font-medium rounded-md', slot.available ? 'bg-purple-200 text-purple-700 hover:bg-purple-300' : 'bg-gray-200 text-gray-400 cursor-not-allowed', selectedSlot === slot ? 'ring-2 ring-purple-500' : '']"
                ...
                <button type="submit" class="w-full px-4 py-2 text-sm font-medium text-white bg-blue-500 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500" :disabled="!selectedInstructor || !selectedDate || !selectedSlot">
                    Confirm Booking
                </button>
            </form>
        </div>
